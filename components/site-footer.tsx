  ...
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="relative bg-gradient-to-br from-[#fff1be] via-[#ee87cb] to-[#b060ff] dark:from-[#2d1d4a] dark:via-[#4a2d4a] dark:to-[#1d1d4a]">
        <div className="absolute inset-2 rounded-4xl bg-white/80 dark:bg-gray-800/80" />
          ...
          <div className="mx-auto max-w-2xl lg:max-w-7xl">
            ...
            <div className="pb-16">
              <div className="group/row relative isolate pt-[calc(theme(spacing.2)+1px)] last:pb-[calc(theme(spacing.2)+1px)]">
                ...
                >
                  <div className="absolute inset-x-0 top-0 border-t border-gray-200 dark:border-gray-700" />
                  <div className="absolute inset-x-0 top-2 border-t border-gray-200 dark:border-gray-700" />
                  <div className="absolute inset-x-0 bottom-0 hidden border-b border-gray-200 group-last/row:block dark:border-gray-700" />
                  <div className="absolute inset-x-0 bottom-2 hidden border-b border-gray-200 group-last/row:block dark:border-gray-700" />
                </div>
