...
export default async function IndexPage(
  ...
  const blogContent = {
    ...
    description: dict.marketing.blog_description,
    image: "/images/blog_img.png",
    authorAvatar: "/images/avatars/koala.svg",
  };

  return (
    <>
      <section className="w-full px-8 sm:px-48 md:px-48 xl:h-screen xl:px-48">
            ...
            <div className="flex flex-col pt-4 md:pt-28 lg:pt-28 xl:pt-28">
              ...
              <div>
                ...
                <TypewriterEffectSmooths
                  text={
                    dict.marketing.word_reveal ||
                    "Empowering Minds: Revolutionize Your Learning Journey with AI"
                  }
                />
              </div>
            ...
            <div className="flex flex-col pt-28">
              ...
              <div className="mt-4 flex w-full justify-between">
                <XBlogArticle
                  ...
                  btnText={dict.marketing.read_more}
                />
                <div className="ml-4">
                  <FeaturesCard />
                </div>
      ...
      <section className="hidden h-screen w-full xl:block">
        <div className="flex size-full justify-between px-[220px]">
          <div className="flex w-3/5 flex-col pr-4 pt-40">
      ...
      <section id="features" className="w-full px-4 py-8">
        <div className="container mx-auto bg-gray-200 px-4 py-8 dark:bg-gray-900">
          <h2 className="mb-12 text-center text-3xl font-bold text-gray-900 dark:text-gray-50">
            {dict.marketing.features_title}
          </h2>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {/* Personalized Learning System */}
            <div className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
              <Image
                src="/images/3dicons/book.png"
                alt="Personalized Learning System"
                width={100}
                height={100}
              />
              <h3 className="mb-2 text-xl font-semibold text-gray-900 dark:text-gray-50">
                {dict.marketing.personalized_learning}
              </h3>
              <p className="text-gray-700 dark:text-gray-200">
                {dict.marketing.personalized_learning_desc}
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
              <Image
                src="/images/3dicons/ai.png"
                alt="Personalized Learning System"
                width={100}
                height={100}
              />
              <h3 className="mb-2 text-xl font-semibold text-gray-900 dark:text-gray-50">
                {dict.marketing.ai_professor}
              </h3>
              <p className="text-gray-700 dark:text-gray-200">
                {dict.marketing.ai_professor_desc}
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
              <Image
                src="/images/3dicons/verified.png"
                alt="Personalized Learning System"
                width={100}
                height={100}
              />
              <h3 className="mb-2 text-xl font-semibold text-gray-900 dark:text-gray-50">
                {dict.marketing.one_stop_shop}
              </h3>
              <p className="text-gray-700 dark:text-gray-200">
                {dict.marketing.one_stop_shop_desc}
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
              <Image
                src="/images/3dicons/chart.png"
                alt="Personalized Learning System"
                width={100}
                height={100}
              />
              <h3 className="mb-2 text-xl font-semibold text-gray-900 dark:text-gray-50">
                {dict.marketing.progress_tracking}
              </h3>
              <p className="text-gray-700 dark:text-gray-200">
                {dict.marketing.progress_tracking_desc}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full px-8 pt-10 sm:px-0 sm:pt-0 md:px-0 md:pt-0 xl:px-0 xl:pt-0">
        <div className="flex size-full flex-col items-center pb-[100px] pt-10">
          <div>
